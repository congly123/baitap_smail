                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(com.example.baitapsmilelogin_androi.Sign.this, com.example.baitapsmilelogin_androi.Feel.class));
                        } else
                        {
                            new AlertDialog.Builder(com.example.baitapsmilelogin_androi.Sign.this)
                                    .setTitle("Confirm")
